...
//	private String makeupId;//등록회원아이디
//	private String code; //메이크업 코드
//	private String makeupName;//메이크업 이름
//	private String makeupTel;//메이크업전홥너호
//	private String makeupLoc;//메이크업지역
//	private String makeupAddr;//메이크업 주소
//	private int makeupBasicPrice;//메이크업 기본가격
//	private int makeupParentPrice;//혼주메이크업가격
//	private int makeupVisitorPrice;//하객메이크업가격
//	private int makeupScope;
