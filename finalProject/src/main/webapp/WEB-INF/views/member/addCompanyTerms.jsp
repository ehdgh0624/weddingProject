			...
			<div class="common-tbl-box">
				<div class="main">
					...
					<div class="terms-box">
						<h3>[제 1장 총칙]</h3>
						<h4>제 1조 목적</h4>
						<p>이 약관은 WEDDING JUO, Inc. (이하 회사 또는 JUO)이 제공하는 모든 서비스의 이용 조건 및 절차에 관한 사항과 기타 필요한 사항을 규정함을 목적으로 합니다.</p>
						<h4>제 2조 효력과 변경</h4>
						<ul class="blNum">
					...
					<p class="terms-chk"><input type="checkbox" id="chk1" name="chk"><label for="chk1">이용약관에 동의합니다.</label></p>
					...
					<p class="terms-chk"><input type="checkbox" id="chk2" name="chk"><label for="chk2">개인정보 수집 및 이용에 동의합니다.<br>
					...
					<p class="terms-chk"><input type="checkbox" id="chk3" name="chk"><label for="chk3">개인정보수집 및 이용에 동의 합니다.</label></p><br>
