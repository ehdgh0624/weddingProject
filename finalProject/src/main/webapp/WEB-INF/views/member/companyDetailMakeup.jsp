	...
	<div id="myPageContainer" class="clearfix">
		...
		<form action="/makeupUpdate.do" method="post">
			...
			<table class="comm-tbl">	
					...
					<tr>
						<th>업체명</th>
						<th><input type="text" name="makeupName" value="${makeup.makeupName }"><input type="hidden" value="${makeup.makeupNo }" id="no"></th>
					</tr>
					
					<tr>
						<th>전화번호</th>
						<th><input type="text" name="makeupTelFi" id="first">-<input type="text" name="makeupTelSe" id="second">-<input type="text" name="makeupTelth" id="third"></th>
					</tr>
					
					<tr>
						<th>메이크업기본가격</th>
						<th><input type="number" name="makeupBasicPrice" value="${makeup.makeupBasicPrice }" ></th>
					</tr>
					
					<tr>
						<th>혼주메이크업가격</th>
						<th><input type="number" name="makeupParentPrice" value="${makeup.makeupParentPrice }"></th>
					</tr>
					<tr>
						<th>하객메이크업가격</th>
						<th><input type="number" name="makeupVisitorPrice" value="${makeup.makeupVisitorPrice }"></th>
					</tr>
					<tr>
						<th>우편번호</th>
						<td><input type="text" id="sample4_postcode" placeholder="우편번호" name="postNum" value="${post }">
							...
							<input type="hidden" name="makeupLatitude" id="shopLatitude" value="${makeup.makeupLatitude }">
							<input type="hidden" name="makeupLongtitude" id="shopLongitude" value="${maekup.makeupLongitud }">
						</td>
					</tr>
					<tr>
						<th>도로명주소</th>
					...
					<tr>
						<th>메이크업컨테츠</th>
						<th><input type="text" name="makeupContent" value="${makeup.makeupContent }"></th>
					</tr>
					<tr>
						<th>업체 상태설정</th>
						<th>
		...
		<div>
			...
			<table class="comm-tbl" id="gall">
					...
					<tr>
						...
						<td><img src="/resources/makeup/${s.filepath }" style="width:300px;height:300px"></td>
