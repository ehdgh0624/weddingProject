							...
							<div class="reviewGroup" id="${r.reviewNo}">
								...
								<div style="width:90%;display: inline-block;">
									...
									<c:if test="${sessionScope.member.memberName == r.reviewWriter}">
										<span style="margin-left:10px;" class="reviewUpdateGroup"><a>수정</a>	 | <a class="deleteReview" style="cursor: pointer;">삭제</a><span class="makeupScopeSpan" style="cursor: inherit;width:10px;visibility: hidden;">${r.reviewScope}</span></span>
									</c:if>
									<span style="float: right;">
