...
<section id="adminWrap">
	...
	<div id="myPageContainer" class="clearfix">
		<!-- 여기에 내용 작서어어어어어엉!!! -->
		<h2 class="comm-content-tit">예약 상세 보기</h2> 
		<div class="area">
			<div class="common-tbl-box">
				<h1 class="main-comm-sub-tit clearfix">
					결혼예정일 : <b>${reservation.weddingDate} ${reservation.weddingTime}</b>
					<span class="fr">총 결제금액 : <b><fmt:formatNumber value="${reservation.totalPrice }"/></b> 원</span>
				</h1>
				<br>
