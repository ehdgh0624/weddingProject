				...
				<div class="headersub area"><!-- 가운데 정렬 div -->
					...
					<form action="/hallSc.do" method="get">
			            ...
			            <div class="hallPerson">
			            	<input type="text" id="hallPerson" class="num" name="hallPerson" placeholder="인원을 입력해주세요.">
			            </div>
							...
							<div class="card" >
								<div class="thumbnail">
									<a href="/hallView.do?hallNo=${h.hallNo}" class="centered">
										<span style="background:url('https://i.pinimg.com/originals/d9/82/f4/d982f4ec7d06f6910539472634e1f9b1.png') no-repeat center center; background-size:cover;"></span>
									</a>
								</div>
								<div class="text">
									<h5 class="clearfix">
								...
								<div class="bottom">
									<p>
										<span>인원</span><b>${h.hallMinPerson } ~ ${h.hallMaxPerson } </b>
									</p>
									<p>
										<span>평점</span><b><img src="/resources/img/scope-star/scope-star${h.scope}.png" style="height:13px;vertical-align: middle;"></b>
									</p>
								</div>
							</div>
							</c:forEach>
