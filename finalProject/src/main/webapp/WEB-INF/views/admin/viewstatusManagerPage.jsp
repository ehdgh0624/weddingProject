...
<section id="adminWrap">
	...
	<div id="companyTypeBtn" class="btn-wrap">
		<button class="btn-samll"
			onclick="location.href='/viewstatusManager.do'">모든업체</button>
		<button class="btn-samll"
			onclick="location.href='/viewstatusManager.do?typeCode=1'">웨딩
			홀</button>
		<button class="btn-samll"
			onclick="location.href='/viewstatusManager.do?typeCode=2'">스튜디오</button>
		<button class="btn-samll"
			onclick="location.href='/viewstatusManager.do?typeCode=3'">드레스</button>
		<button class="btn-samll"
			onclick="location.href='/viewstatusManager.do?typeCode=4'">메이크업</button>
	</div>
